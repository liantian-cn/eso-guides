...
* **跳跃** :  就像普通的阿利特一样，它们会跳起来然后以重击形式砸回地面。如果你是坦克，当然应该用盾牌格挡以防止被击倒。如果你是DPS或治疗者，并且由于某些原因它们攻击你，同样适用...确保你格挡攻击。另外，专有名词的翻译为：Len（莱恩）、En（恩）、Shade（幽影）、Ardia（艾尔迪亚）、Vigor（活力）、Guard（守卫）。
